...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if ($action === 'create') {
        ...
        if (!empty($errors)) {
            ...
            header("Location: ../view/frontend/repas/fo_repaslist.php?error=" . $msg);
            exit;
        }
        ...
        header("Location: ../view/frontend/repas/fo_repaslist.php?success=created");
        exit;
    }
    ...
    if ($action === 'update') {
        ...
        if ($id <= 0 || strlen($nom) < 2 || empty($date)) {
            header("Location: ../view/frontend/repas/fo_updaterepas.php?id=$id&error=validation");
            exit;
        }
        ...
        header("Location: ../view/frontend/repas/fo_repaslist.php?success=updated");
        exit;
    }
}
...
if (isset($_GET['action']) && $_GET['action'] === 'delete') {
    ...
    header("Location: ../view/frontend/repas/fo_repaslist.php?success=deleted");
    exit;
}
?>
