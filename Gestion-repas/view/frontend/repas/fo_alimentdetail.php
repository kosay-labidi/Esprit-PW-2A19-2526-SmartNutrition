...
<head>
    ...
    <script src="https://cdnjs.cloudflare.com/ajax/libs/Chart.js/4.4.1/chart.umd.min.js"></script>
        ...
        <link rel="stylesheet" href="../css/fo_alimentdetail.css">

    <script src="../js/fo_alimentdetail.js"></script>
...
<!-- ══════════════════════════════════════════════════════════
     ...
     ══════════════════════════════════════════════════════════ -->
<div class="aliment-hero" style="margin-top:10px;background:linear-gradient(135deg,<?= $c['bg'] ?> 0%,white 70%);border-bottom:1px solid <?= $c['stroke'] ?>33;">
