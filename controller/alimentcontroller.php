...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (isset($_POST['action'])) {
        if ($_POST['action'] === 'create') {
            ...
            header("Location: ../view/backend/bo_alimentlist.php?success=created");
        } elseif ($_POST['action'] === 'update') {
            aliment_update($pdo, $_POST['id_aliment'], $data);
            header("Location: ../view/backend/bo_alimentlist.php?success=updated");
        }
    }
    exit;
}
...
if (isset($_GET['action']) && $_GET['action'] === 'delete') {
    ...
    header("Location: ../view/backend/bo_alimentlist.php?success=deleted");
    exit;
}
?>
