...
CREATE TABLE IF NOT EXISTS `challenge` (
    ...
    `est_payant`   TINYINT(1)     NOT NULL DEFAULT 0
                   COMMENT '1 = défi payant, 0 = gratuit',
    `prix`         DECIMAL(10,2)  NOT NULL DEFAULT 0.00
                   COMMENT 'Prix du défi si payant',
...
-- ---------------------------------------------------------------
-- 3.b TABLE : paiement_defi
--     Paiement simulé pour les défis payants
-- ---------------------------------------------------------------
CREATE TABLE IF NOT EXISTS `paiement_defi` (
  ...
  DEFAULT CHARSET=utf8mb4
  COLLATE=utf8mb4_unicode_ci
  COMMENT='Paiements simulés des défis payants';
