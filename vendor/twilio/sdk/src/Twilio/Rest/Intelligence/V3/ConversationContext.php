...
class ConversationContext extends InstanceContext
    ...
    public function fetch(): FetchConversation200ResponseInstance
    {
        ...
        return new FetchConversation200ResponseInstance(
            $this->version,
            $response->getContent(),
            $this->solution['id']
        );
    ...
    /**
     * Fetch the FetchConversation200ResponseInstance with Metadata
     *
    ...
    {
        $response = $this->_fetch();
        $resource = new FetchConversation200ResponseInstance(
                        $this->version,
                        $response->getContent(),
                        $this->solution['id']
                    );
    ...
    public function __toString(): string
    {
        ...
        return '[Twilio.Intelligence.V3.ConversationContext ' . \implode(' ', $context) . ']';
    }
}
