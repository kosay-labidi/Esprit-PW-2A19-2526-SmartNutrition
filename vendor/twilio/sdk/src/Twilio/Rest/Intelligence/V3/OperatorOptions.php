...
abstract class OperatorOptions
{
    ...
    /**
     * @param string $ifMatch Current ETag/version required for conditional update
     * @return UpdateOperatorOptions Options builder
     */
    ...
    {
        return new UpdateOperatorOptions(
            $ifMatch
        );
    }
...
class ReadOperatorOptions extends Options
    ...
    public function __toString(): string
    {
        ...
        return '[Twilio.Intelligence.V3.ReadOperatorOptions ' . $options . ']';
    }
}

class UpdateOperatorOptions extends Options
    {
    /**
     * @param string $ifMatch Current ETag/version required for conditional update
     */
    ...
    {
        $options = \http_build_query(Values::of($this->options), '', ' ');
        return '[Twilio.Intelligence.V3.UpdateOperatorOptions ' . $options . ']';
    }
}
