...
<head>
    ...
    <title>Régimes Alimentaires - Export PDF</title>
    <style>
...
<body>
    ...
    <div class="stats">
        <div class="stat-item">
            <strong>Total Régimes:</strong>
            <span><?= count($regimes) ?></span>
        </div>
        <div class="stat-item">
            <strong>Types de Régimes:</strong>
            <span><?= count(array_unique(array_column($regimes, 'type_regime'))) ?></span>
        </div>
    </div>
    ...
    <table>
        ...
        <tbody>
            ...
            <tr>
                <td><?= htmlspecialchars($r['id_regime']) ?></td>
                <td><?= htmlspecialchars($r['nom_regime']) ?></td>
                <td><?= htmlspecialchars($r['type_regime'] ?? '-') ?></td>
                <td><?= htmlspecialchars($r['niveau_difficulte'] ?? '-') ?></td>
                <td><?= number_format($r['apport_calorique_moyen'], 0) ?> kcal</td>
