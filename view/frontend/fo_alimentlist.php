        ...
        * { font-family:'Lato',sans-serif; box-sizing:border-box; margin:0; padding:0; }
        ...
        .hero {
            background: linear-gradient(rgba(26,55,47,.68), rgba(26,55,47,.68)) center/cover no-repeat,
                        url('../BackOffice/assets/images/1000051721.jpg') center/cover no-repeat;
            padding: 52px 0 40px;
        }
        body.dark .hero {
            background: linear-gradient(rgba(8,15,24,.60), rgba(8,15,24,.60)) center/cover no-repeat,
                        url('../BackOffice/assets/images/1000051721.jpg') center/cover no-repeat !important;
        }
        ...
        body.dark .hero { background-image:linear-gradient(rgba(8,15,24,.60),rgba(8,15,24,.60)),url('../BackOffice/assets/images/1000051721.jpg') !important; }
