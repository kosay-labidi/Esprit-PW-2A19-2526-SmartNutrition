...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && $dossier) {
    try {
        ...
        header('Location: /crud/Esprit-PW-2A19-2526-SmartNutrition/view/frontend/dashboard.html?msg=updated');
        exit;
    } catch (Exception $e) {
    ...
    <div class="glass">
        ...
        <form method="POST" onsubmit="return validateForm()">
            ...
            <div class="button-group">
                ...
                <a href="/crud/Esprit-PW-2A19-2526-SmartNutrition/view/frontend/dashboard.html" class="btn btn-back">← Retour</a>
            </div>
        </form>
    </div>
    <script>
